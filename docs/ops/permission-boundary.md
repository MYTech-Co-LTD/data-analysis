...
| **组织架构目录** | 部门/区域/门店层级（谁在哪个部门、哪个门店） | **Casdoor Group tree**（组同步器 auto + Casdoor UI manual；本地 org_departments/org_users 降级只读投影） | **仅目录/审计用途——不推导门店数据范围**（2026-08-18 废除组织架构推导；门店范围唯一真相 = `范围\|X` 资源） |
