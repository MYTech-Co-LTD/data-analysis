...
export const METRICS: Record<MetricCode, MetricMeta> = {
  sale:            { code:"sale",            label:"门店零售金额完成率", unit:"元", trendTable:"report_daily_sales",    trendValueCol:"total_sale" },
  delivery:        { code:"delivery",         label:"门店配送金额完成率", unit:"元", trendTable:"report_daily_delivery", trendValueCol:"out_money" },
  outbound_amt:    { code:"outbound_amt",     label:"供应链出库目标完成率", unit:"元", trendTable:"report_daily_delivery", trendValueCol:"out_money",
                     secondaryTable:"report_daily_wholesale", secondaryValueCol:"wholesale_money", categoryIn:["水果","标品耗材"] },
  outbound_profit: { code:"outbound_profit",  label:"供应链出库毛利完成率", unit:"元", trendTable:"report_daily_delivery", trendValueCol:"profit_money",
