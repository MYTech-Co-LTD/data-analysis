...
export async function PUT(req: NextRequest, { params }: RouteCtx) {
  ...
  if (SCOPE_KEYS.some(k => k in b)) {
    merged = {
      branch_nums: 'branch_nums' in b ? b.branch_nums : oldPermRow?.branch_nums ?? null,
      brands: 'brands' in b ? b.brands : oldPermRow?.brands ?? null,
      categories: 'categories' in b ? b.categories : oldPermRow?.categories ?? null,
